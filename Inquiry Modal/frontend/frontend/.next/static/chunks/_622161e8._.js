...
"[project]/utils/config.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const NotificationProvider = ({ children })=>{
    ...
    const [userKey, setUserKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); // ❌ no localStorage here
    const [token, setToken] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const API_URL = `${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}`;
    ...
    const fetchNotifications = async ()=>{
        ...
        try {
            ...
            const filtered = data.filter((n)=>n.type === "add");
            setNotifications(data);
        } catch (err) {
            console.error('Failed to fetch notifications:', err);
        }
    };
    const addNotification = async (message, visibleTo)=>{
        if (!token) return;
        try {
...
_s(NotificationProvider, "8X6LmVRjVV3PEapGJw7oCJ8yd1Q=");
_c = NotificationProvider;
const useNotification = (p0)=>{
    _s1();
...
//# sourceMappingURL=_622161e8._.js.map