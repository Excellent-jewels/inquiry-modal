...
;
;
fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/api/inquiries`);
const images = [
    "/image2.jpg",
    "/image4.jpg",
    "/image6.jpg"
...
function LoginPage() {
        ...
        "LoginPage.useEffect": ()=>{
            const interval = setInterval({
                "LoginPage.useEffect.interval": ()=>{
                    setCurrent({
                        "LoginPage.useEffect.interval": (prev)=>(prev + 1) % images.length
                    }["LoginPage.useEffect.interval"]);
                }
            }["LoginPage.useEffect.interval"], 3000);
            return ({
    ...
    const handleSendOtp = async (e)=>{
        e.preventDefault();
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/auth/send-otp`, {
                method: "POST",
                headers: {
    ...
    const handleVerifyOtp = async (e)=>{
        e.preventDefault();
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/auth/verify-otp`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    const handleResetPassword = async (e)=>{
        ...
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/auth/reset-password`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    const handleSignIn = async (e)=>{
        e.preventDefault();
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]}/auth/login`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
...
_s(LoginPage, "Sde34scUTDBaDHIbUZH/57gwrGw=", false, function() {
    return [
